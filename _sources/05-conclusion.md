...
* **Pengembangan Metode**: Menggunakan teknik pemutihan awan (*cloud masking*) berdasarkan *quality flag* S5P band $NO_2$ agar data interpolasi lebih presisi.
* **Integrasi Data**: Menggabungkan data satelit dengan sensor darat (ISPU) untuk validasi silang (*cross-validation*) kualitas udara secara *real-time*.